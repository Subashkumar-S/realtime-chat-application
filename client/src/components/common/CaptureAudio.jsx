...
function CaptureAudio({ hide }) {
  ...
  const handleStartRecording = () => {
    ...
    navigator.mediaDevices.getUserMedia({ audio: true }).then((stream) => {
      ...
      .catch((error) => {
        console.log("Error accessing micophone:", error);
      });
  ...
  return (
    <div className="flex text-2xl w-full justify-end items-center">
      ...
      <div className="mx-4 px-4 text-white text-lg flex gap-3 justify-center items-center bg-search-input-container-background rounded-full drop-shadow-lg">
        {isRecording ? (
